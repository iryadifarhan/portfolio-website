...
function waitForStaticAssets(timeoutMs = 1000) {
  if (typeof window === "undefined") return Promise.resolve();

  // Only wait for priority/above-the-fold images (not lazy-loaded ones)
  const elements = Array.from(
    document.querySelectorAll("img[loading='eager'], img[priority], video")
