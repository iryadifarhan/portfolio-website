...
export const WORKS: Work[] = [
  {
    ...
    tags: ["Snipe-IT", "Laravel", "Livewire", "PHP", "HTML", "JavaScript", "JQuery", "Bootstrap", "Postman", "MySQL", "Bash", "Linux", "MinIO", "NGINX", "Docker", "Docker Compose", "Harbor", "Jenkins", "GitLab", "MkDocs", "Outline", "Marp", "Jira"],
    ...
    contributions: [ 
      { 
        ...
        description: "As part of an Agile Scrum team, I contributed to the full development lifecycle of the project—from refining requirements to deploying releases using. Here, I applied <strong>Scrum & Kanban</strong> method using <strong>Jira</strong> to handle project management. I handled branch management of code repository using <strong>GitLab</strong> and <strong>GitFlow</strong>, documented technical guidelines using <strong>MkDocs</strong> and <strong>Outline</strong>, and created presentation-ready documentation with <strong>Marp</strong> and <strong>PowerPoint</strong>. I also participated as a <strong>speaker</strong> in a dedicated event for Asset Management showcase, where I convey product upgrades and innovations toward IDEMIA Jakarta for feedback and improvement."
      },
      { 
        title: "Fullstack Developing",
        description: "I continued the improvement of IDEMIA’s customized <strong>Snipe-IT</strong> system by manually upgrading the core platform from <strong>v6.0.7</strong> to <strong>v8.1.2</strong>, resolving compatibility gaps along the way. My responsibilities included fixing bugs, implementing and refining new features, ensuring forward-compatible code, and integrating external services such as <strong>LDAP</strong> for authentication and <strong>MinIO</strong> for object storage. To maintain code quality and ensure its free of bugs, I also implemented <strong>PHPUnit</strong> test suites for reliable regression testing. In addition, I actively contributed to the open-source <strong>Snipe-IT</strong> project by submitting improvements and fixes through pull requests (<a class='text-blue-500 underline' href='https://github.com/grokability/snipe-it/pull/18257' target='_blank' rel='noopener noreferrer'>#18257</a>, <a class='text-blue-500 underline' href='https://github.com/grokability/snipe-it/pull/18256' target='_blank' rel='noopener noreferrer'>#18256</a>, and <a class='text-blue-500 underline' href='https://github.com/grokability/snipe-it/pull/18248' target='_blank' rel='noopener noreferrer'>#18248</a>)."
      },
      { 
